...
<svelte:head>
  <title>Chloe & Skyler — November 22, 2025</title>
  <meta name="description" content="Join us in celebrating our covenant before God. Chloe & Skyler's wedding on November 22, 2025, at 2:30 PM. A gospel-centered celebration of love." />
</svelte:head>
...
<section class="relative h-[500px] md:h-[600px] overflow-hidden">
  ...
  <div class="absolute inset-0">
    ...
    />
    <!-- Overlay -->
    <div class="absolute inset-0 bg-coffee-900/30"></div>
  </div>
  ...
  <div class="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 text-center">
    {#if mounted}
      ...
      >
        We joyfully invite you to witness our covenant — Mr. Darcy
      </p>
  ...
  <div class="max-w-4xl mx-auto text-center">
    ...
    <div class="prose prose-lg max-w-none text-coffee-900">
      <p class="text-base md:text-lg leading-relaxed">
        ...
        As believers in the Gospel, we see marriage as a reflection of Christ's love for His Church. 
        We gather together not just as friends and family, but as a community united in faith, 
        to celebrate God's grace and faithfulness in bringing us together.
      </p>
    </div>
    
    <!-- Decorative Element -->
    <div class="flex items-center justify-center mt-8 space-x-4 text-coffee-600">
      <div class="flex items-center space-x-2">
        <span class="text-2xl">☕</span>
        <span class="w-8 h-px bg-coffee-400"></span>
        <span class="text-2xl">💒</span>
        <span class="w-8 h-px bg-coffee-400"></span>
        <span class="text-2xl">✨</span>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="text-center group">
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <h3 class="text-xl font-serif font-semibold text-coffee-800 mb-2">Our Story</h3>
          <p class="text-coffee-600 text-sm mb-4">
            From Mean Mug to forever — discover how our love story began with coffee and faith.
          </p>
          <a 
            href="/story" 
      ...
      <div class="text-center group">
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <span class="text-4xl mb-4 block">🎁</span>
          <h3 class="text-xl font-serif font-semibold text-coffee-800 mb-2">Wedding Registry</h3>
          <p class="text-coffee-600 text-sm mb-4">
            Help us build our home together with items from our carefully curated registries.
          </p>
          <a 
            href="/registry" 
            class="inline-block text-coffee-700 font-medium hover:text-coffee-900 transition-colors duration-300 group-hover:underline"
      ...
      <div class="text-center group">
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <h3 class="text-xl font-serif font-semibold text-coffee-800 mb-2">RSVP</h3>
          <p class="text-coffee-600 text-sm mb-4">
            Let us know if you'll join us for this special celebration of covenant and community.
          </p>
          <a 
            href="/rsvp" 
